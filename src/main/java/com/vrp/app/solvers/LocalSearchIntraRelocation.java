 ...
 */
public class LocalSearchRelocation implements Solver {
    ...
    public LocalSearchRelocation(int numberOfCustomers, int numberOfVehicles, Node depot, double[][] distanceMatrix, ArrayList<Node> allNodes) {
        this.depot = depot;
